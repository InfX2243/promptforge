      ...
      <PageContainer>
        ...
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <div className="hidden md:block">
            ...
            <button
              ...
              className="micro-button inline-flex min-w-32 items-center justify-between gap-3 rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2 text-[var(--font-size-sm)] text-[var(--color-text-muted)] transition-colors duration-150 hover:border-[var(--color-border-strong)] hover:text-[var(--color-text-secondary)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent)]"
        ...
        {mobileMenuOpen && (
          <nav
            ...
            className="micro-mobile-menu border-t border-[var(--color-border-subtle)] py-3 md:hidden"
          >
            {" "}
